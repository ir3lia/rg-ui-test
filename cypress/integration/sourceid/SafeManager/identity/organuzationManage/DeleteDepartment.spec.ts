...
describe('删除部门成功', () => {
  ...
  it('删除部门成功', () => {
    ...
    cy.get(
      ' body > app-root > app-header-layout > div > app-menu-layout > div.layout-right-describe > div > app-list > app-main-constructor > article > section.main-content.ant-row > div > div > section > div > ul'
    ).click();
